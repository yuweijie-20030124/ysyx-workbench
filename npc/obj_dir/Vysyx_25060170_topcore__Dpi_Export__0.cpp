...
void Vysyx_25060170_topcore::IDU_SEND_CALL_FLAG(int* call_flag, int* pc, int* dnpc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25060170_topcore___024root::IDU_SEND_CALL_FLAG\n"); );
    // Init
...
void Vysyx_25060170_topcore::IDU_SEND_RET_FLAG(int* ret_flag, int* pc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25060170_topcore___024root::IDU_SEND_RET_FLAG\n"); );
    // Init
