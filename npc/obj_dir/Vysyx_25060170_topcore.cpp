...
Vysyx_25060170_topcore::Vysyx_25060170_topcore(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new Vysyx_25060170_topcore__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , rootp{&(vlSymsp->TOP)}
{
...
Vysyx_25060170_topcore::Vysyx_25060170_topcore(const char* _vcname__)
    : Vysyx_25060170_topcore(Verilated::threadContextp(), _vcname__)
{
}
...
Vysyx_25060170_topcore::~Vysyx_25060170_topcore() {
    delete vlSymsp;
}
...
#endif  // VL_DEBUG
void Vysyx_25060170_topcore___024root___eval_static(Vysyx_25060170_topcore___024root* vlSelf);
void Vysyx_25060170_topcore___024root___eval_initial(Vysyx_25060170_topcore___024root* vlSelf);
void Vysyx_25060170_topcore___024root___eval_settle(Vysyx_25060170_topcore___024root* vlSelf);
void Vysyx_25060170_topcore___024root___eval(Vysyx_25060170_topcore___024root* vlSelf);

void Vysyx_25060170_topcore::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vysyx_25060170_topcore::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
    Vysyx_25060170_topcore___024root___eval_debug_assertions(&(vlSymsp->TOP));
#endif  // VL_DEBUG
    ...
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) {
        ...
        Vysyx_25060170_topcore___024root___eval_static(&(vlSymsp->TOP));
...
const char* Vysyx_25060170_topcore::name() const {
    return vlSymsp->name();
}
...
void Vysyx_25060170_topcore___024root___eval_final(Vysyx_25060170_topcore___024root* vlSelf);

VL_ATTR_COLD void Vysyx_25060170_topcore::final() {
    Vysyx_25060170_topcore___024root___eval_final(&(vlSymsp->TOP));
}
