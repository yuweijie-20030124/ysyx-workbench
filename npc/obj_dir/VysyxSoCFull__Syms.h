...
using VysyxSoCFull__Vcb_IDU_SEND_CALL_FLAG_t = void (*) (VysyxSoCFull__Syms* __restrict vlSymsp, IData/*31:0*/ &call_flag, IData/*31:0*/ &pc, IData/*31:0*/ &dnpc);
using VysyxSoCFull__Vcb_IDU_SEND_RET_FLAG_t = void (*) (VysyxSoCFull__Syms* __restrict vlSymsp, IData/*31:0*/ &ret_flag, IData/*31:0*/ &pc);
...
class alignas(VL_CACHE_LINE_BYTES)VysyxSoCFull__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope __Vscope_ysyxSoCFull__asic__cpu__cpu__u_ysyx_25060170_DPIC;
