...
extern "C" {
    ...
    // DPI export at vsrc/ysyx_25060170_IDU.v:222:6
    extern void IDU_SEND_CALL_FLAG(int* call_flag, int* pc, int* dnpc);
    // DPI export at vsrc/ysyx_25060170_IDU.v:200:6
    extern void IDU_SEND_INST(int* c_inst);
    // DPI export at vsrc/ysyx_25060170_IDU.v:210:6
    ...
    // DPI import at vsrc/ysyx_25060170_IDU.v:189:30
