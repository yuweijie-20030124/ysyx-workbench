...
extern "C" {
    ...
    // DPI EXPORTS
    // DPI export at vsrc/core/ysyx_25060170_DPIC.v:220:6
    extern void IDU_SEND_CALL_FLAG(int* call_flag, int* pc, int* dnpc);
    // DPI export at vsrc/core/ysyx_25060170_DPIC.v:239:6
    extern void IDU_SEND_RET_FLAG(int* ret_flag, int* pc);

    // DPI IMPORTS
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:83:30
    ...
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:81:30
    extern void magic_instruction();
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:73:30
    extern void pc_inst_end(int thepc_data, int the_inst);
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:75:30
    extern void pmem_read(int raddr, int* rdata, char rlen);
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:77:30
    extern void pmem_write(int waddr, int wdata, char wlen);
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:79:30
