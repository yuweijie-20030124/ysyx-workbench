...
#ifndef VERILATED_VYSYX_25060170_FISHTAILCORE__DPI_H_
#define VERILATED_VYSYX_25060170_FISHTAILCORE__DPI_H_  // guard
...
extern "C" {
    ...
    // DPI EXPORTS
    // DPI export at vsrc/core/ysyx_25060170_DPIC.v:268:6
    extern void IDU_SEND_CALL_FLAG(int* call_flag, int* pc, int* dnpc);
    // DPI export at vsrc/core/ysyx_25060170_DPIC.v:287:6
    extern void IDU_SEND_RET_FLAG(int* ret_flag, int* pc);

    // DPI IMPORTS
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:101:30
    extern void difftest_dut_csr(int csr_mstatus, int csr_mtvec, int csr_mepc, int csr_mcause);
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:108:30
    ...
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:99:30
    ...
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:95:30
    extern void pmem_write(int waddr, int wdata, char wlen, int* dpic_difftest_skip_flag);
    // DPI import at vsrc/core/ysyx_25060170_DPIC.v:97:30
