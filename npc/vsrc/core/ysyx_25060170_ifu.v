...
module ysyx_25060170_ifu(
    ...
    ,input  wire                        ex_pc_jump_i    //<<i<<
    ,input  wire [`ysyx_25060170_PC]    ex_pc_i         //<<i<<
    ...
    //out for idu
    ,input  wire [`ysyx_25060170_INST]  inst_i          //>>o>>
    ,input  wire [`ysyx_25060170_PC]    pc_i            //>>o>>
    ,output wire [`ysyx_25060170_PC]    pc_o            //>>o>>
    ,output wire [`ysyx_25060170_INST]  inst_o          //>>o>>
    ,output wire [`ysyx_25060170_PC]    pc_next_o       //>>o>>
