...
module ysyx_25060170_ifuidureg(
    ...
    ,input  logic [`ysyx_25060170_INST]     ifu_ifuidureg_inst
    ...
    ,output logic [`ysyx_25060170_INST]     ifuidureg_idu_inst       
...
//流水线控制
wire stall = idu_ifuidureg_stall | lsu_ifuidureg_stall | idu_ifuidureg_stall | ~ifu_ifuidureg_valid | ~idu_ifuidureg_ready;
...
always_ff @(posedge clk) begin
    if(rst) begin
        ...
        ifuidureg_idu_inst       <= `ysyx_25060170_ZERO32      ;
        ...
        ifuidureg_idu_inst       <= ifu_ifuidureg_inst        ;
