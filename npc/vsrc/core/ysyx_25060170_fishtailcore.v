...
,output wire  					        DPIC_ls_dpic_we                
,output wire [`ysyx_25060170_DATA]      DPIC_ls_dpic_data              
,output wire [7:0]                      DPIC_ls_dpic_wlen              
,output wire [7:0]                      DPIC_ls_dpic_rlen                 
,output wire [`ysyx_25060170_INST]      DPIC_wbu_dpic_inst	            
,output wire [`ysyx_25060170_PC]        DPIC_wbu_dpic_pc	            
,output wire [`ysyx_25060170_PC]        DPIC_wbu_dpic_next_pc	        
// ,DPIC_wbu_dpic_ls_valid	            
// ,DPIC_wbu_dpic_id_stall	            
,output wire                            DPIC_wbu_dpic_valid            
// ,DPIC_wbu_dpic_pipeline_idstall 
...
ysyx_25060170_btb u_ysyx_25060170_btb(
    ...
    ,.idu_btb_updatePC      ()//<<i<<
    ,.idu_btb_updateTarget  ()//<<i<<
    ,.idu_btb_mispredicted  ()//<<i<<
    ,.btb_valid             ()//>>o>>
    ,.btb_target            ()//>>o>>
    ,.btb_predictedTaken    ()//>>o>>
);
...
ysyx_25060170_ifu1 u_ysyx_25060170_ifu1(
    ...
    ,.ifu2_ifu1_stall           ()//<<i<<
    ,.ifu1_ifu2_valid           ()//>>o>>
    ,.ifu1_ifu2_current_pc      (ifu1_ifu2_current_pc)//>>o>>
    ,.ifu1_ifu2_next_pc         ()//>>o>>
    ,.ifu1_ifu2_bpupredict      ()//>>o>>
);

ysyx_25060170_if1if2reg u_ysyx_25060170_if1if2reg(
     .rst                       (rst)//<<i<<
    ,.clk                       (clk)//<<i<<
    ,.ifu1_if1if2reg_currentpc  ()//<<i<<
    ,.ifu1_if1if2reg_nextpc     ()//<<i<<
    ,.ifu1_if1if2reg_bpupredict ()//<<i<<
    ,.ifu1_if1if2reg_valid      ()//<<i<<
    ,.ifu2_if1if2reg_ready      ()//<<i<<
    ,.ifu2_if1if2reg_stall      ()//<<i<<
    ,.idu_if1if2reg_stall       ()//<<i<<
    ,.idu_if1if2reg_flush       ()//<<i<<
    ,.lsu_if1if2reg_stall       ()//<<i<<
    ,.lsu_if1if2reg_flush       ()//<<i<<
    ,.if1if2reg_ifu2_currentpc  ()//>>o>>
    ,.if1if2reg_ifu2_nextpc     ()//>>o>>
    ,.if1if2reg_ifu2_bpupredict ()//>>o>>
    ,.if1if2reg_ifu2_valid      ()//>>o>>
);

ysyx_25060170_ifu2 u_ysyx_25060170_ifu2(
     .if1if2reg_ifu2_currentpc  ()//<<i<<
    ,.if1if2reg_ifu2_nextpc     ()//<<i<<
    ,.if1if2reg_ifu2_bpupredict ()//<<i<<
    ,.if1if2reg_ifu2_valid      ()//<<i<<
    ,.ram_ifu2_inst             ()//<<i<<
    ,.idu_ifu2_ready            ()//<<i<<
    ,.idu_ifu2_stall            ()//<<i<<
    ,.if2_idu_valid             ()//<<i<<
    ,.ifu2_if2idreg_currentpc   ()//>>o>>
    ,.ifu2_if2idreg_nextpc      ()//>>o>>
    ,.ifu2_if2idreg_bpupredict  ()//>>o>>
    ,.ifu2_if2idreg_valid       ()//>>o>>
    ,.ifu2_if2idreg_inst        ()//>>o>>
);

ysyx_25060170_if2idureg u_ysyx_25060170_if2idureg(
     .rst                       (rst)//<<i<<
    ,.clk                       (clk)//<<i<<
    ,.ifu2_if2idureg_currentpc  ()//<<i<<
    ,.ifu2_if2idureg_inst       ()//<<i<<
    ,.ifu2_if2idureg_nextpc     ()//<<i<<
    ,.ifu2_if2idureg_bpupredict ()//<<i<<
    ,.ifu2_if2idureg_valid      ()//<<i<<
    ,.idu_if2idureg_ready       ()//<<i<<
    ,.idu_if2idureg_stall       ()//<<i<<
    ,.idu_if2idureg_flush       ()//<<i<<
    ,.lsu_if2idureg_stall       ()//<<i<<
    ,.lsu_if2idureg_flush       ()//<<i<<
    ,.if2idureg_idu_currentpc   ()//>>o>>  
    ,.if2idureg_idu_inst        ()//>>o>>  
    ,.if2idureg_idu_nextpc      ()//>>o>>  
    ,.if2idureg_idu_bpupredict  ()//>>o>>  
    ,.if2idureg_idu_valid       ()//>>o>>   
);
...
wire [`ysyx_25060170_DATA]      exu_csr_data;
...
wire  [`ysyx_25060170_DATA]      ex_ls_reg_csr_data;
...
ysyx_25060170_ex_ls_reg u_ysyx_25060170_ex_ls_reg (
    ...
    ,.csr_data_o             ( ex_ls_reg_csr_data     )//>>o>>
...
ysyx_25060170_ls_mem_reg u_ysyx_25060170_ls_mem_reg (
    ...
    ,.csr_data_i             ( ex_ls_reg_csr_data      )//<<i<<
...
ysyx_25060170_wbu u_ysyx_25060170_wbu (
    ...
    //out for DPIC 发射      
    ,.wbu_dpic_inst_o           ( DPIC_wbu_dpic_inst                 )//>>o>>
    ,.wbu_dpic_pc_o             ( DPIC_wbu_dpic_pc                   )//>>o>>
    ,.wbu_dpic_next_pc_o        ( DPIC_wbu_dpic_next_pc              )//>>o>>
    // ,.wbu_dpic_ls_valid_o       ( wbu_dpic_ls_valid             )//>>o>>
    // ,.wbu_dpic_id_stall_o       ( wbu_dpic_id_stall             )//>>o>>
    ,.wbu_dpic_valid_o          ( DPIC_wbu_dpic_valid                )//>>o>>
...
// wire [`ysyx_25060170_REG]       DPIC_regs0;
// wire [`ysyx_25060170_REG]       DPIC_regs1;
// wire [`ysyx_25060170_REG]       DPIC_regs2;
// wire [`ysyx_25060170_REG]       DPIC_regs3;
// wire [`ysyx_25060170_REG]       DPIC_regs4;
// wire [`ysyx_25060170_REG]       DPIC_regs5;
// wire [`ysyx_25060170_REG]       DPIC_regs6;
// wire [`ysyx_25060170_REG]       DPIC_regs7;
// wire [`ysyx_25060170_REG]       DPIC_regs8;
// wire [`ysyx_25060170_REG]       DPIC_regs9;
// wire [`ysyx_25060170_REG]       DPIC_regs10;
// wire [`ysyx_25060170_REG]       DPIC_regs11;
// wire [`ysyx_25060170_REG]       DPIC_regs12;
// wire [`ysyx_25060170_REG]       DPIC_regs13;
// wire [`ysyx_25060170_REG]       DPIC_regs14;
// wire [`ysyx_25060170_REG]       DPIC_regs15;
// wire [`ysyx_25060170_REG]       DPIC_regs16;
// wire [`ysyx_25060170_REG]       DPIC_regs17;
// wire [`ysyx_25060170_REG]       DPIC_regs18;
// wire [`ysyx_25060170_REG]       DPIC_regs19;
// wire [`ysyx_25060170_REG]       DPIC_regs20;
// wire [`ysyx_25060170_REG]       DPIC_regs21;
// wire [`ysyx_25060170_REG]       DPIC_regs22;
// wire [`ysyx_25060170_REG]       DPIC_regs23;
// wire [`ysyx_25060170_REG]       DPIC_regs24;
// wire [`ysyx_25060170_REG]       DPIC_regs25;
// wire [`ysyx_25060170_REG]       DPIC_regs26;
// wire [`ysyx_25060170_REG]       DPIC_regs27;
// wire [`ysyx_25060170_REG]       DPIC_regs28;
// wire [`ysyx_25060170_REG]       DPIC_regs29;
// wire [`ysyx_25060170_REG]       DPIC_regs30;
// wire [`ysyx_25060170_REG]       DPIC_regs31;
...
//     ,.inst_o                     ( DPIC_dpic_ifu_inst             )//>>o>>
//     ,.ftrace_pc                  ( if_id_reg_pc              )//>>o>>
//     ,.rd_addr                    ( DPIC_idu_dpic_rd_addr          )//<<i<<
//     ,.imm                        ( DPIC_idu_imm                   )//<<i<<
//     ,.regs0                      ( regs0                     )//<<i<<
//     ,.regs1                      ( regs1                     )//<<i<<
//     ,.regs2                      ( regs2                     )//<<i<<
...
//     ,.re                         ( DPIC_ls_mem_re                 )//<<i<<
//     ,.we                         ( DPIC_ls_dpic_we                )//<<i<<
//     ,.data_i                     ( DPIC_ls_dpic_data              )//<<i<<
//     ,.wlen                       ( DPIC_ls_dpic_wlen              )//<<i<<
//     ,.rlen                       ( DPIC_ls_dpic_rlen              )//<<i<<
//     ,.dpic_difftest_skip_flag    ( DPIC_dpi_ls_mem_skip_flag      )//>>o>>
//     ,.wbu_DPIC_difftest_skip_flag( DPIC_mem_wb_skip_flag          )//<<i<<
...
//     ,.data_o                     ( DPIC_DPIC_MEM_data             )//>>o>>
//     ,.raddr                      ( DPIC_ls_dpic_raddr             )//<<i<<
//     ,.waddr                      ( DPIC_ls_dpic_waddr             )//<<i<<
//     ,.ex_ls_reg_DPIC_pc_i        ( ex_ls_reg_pc              )//<<i<<
//     ,.DPIC_magic_flag                 ( DPIC_magic_flag                )//<<i<<
// );
